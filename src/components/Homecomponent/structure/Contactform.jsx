            ...
            <div className='container'>
                <Row gutter={[24, 24]} align={'middle'}>
                    <Col span={24}>
                        <Flex vertical justify='center' align='center' gap={10} className='mx-width'>
                            ...
                            <Title className='m-0' level={2}>
                                {t("Reach Out to")} <span className='text-brand'>{t("Jusoor Team")}</span>
                            </Title>
                            <Text className='fs-14'>
                                {t("Have a question about a listing or need help getting started? Our team is here to assist you at every stage — from browsing businesses to finalizing the deal. Get in touch and let us guide you through the process with confidence.")}
                            </Text>
                        </Flex>
                    </Col>
                    ...
                    <Col lg={{span: 11}} md={{span: 0}} sm={{span: 0}} xs={{span: 0}}>
                        <Flex justify='center'>
                            <Image src='/assets/images/contact.png' alt={t('contact image')} preview={false} />
                        </Flex>
                    </Col>
                            ...
                            <Row>
                                ...
                                <Col span={24}>
                                    <Flex gap={10} align='center' justify='center'>
                                        <Text className='text-gray fs-13'>{t('Message Us on WhatsApp')}</Text>
                                        <Button aria-labelledby={t('Whatsapp')} className='bg-green text-white rounded-20 fs-13'>
