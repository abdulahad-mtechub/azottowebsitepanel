...
const steps = [
  {
    ...
    description: 'Add your business info, financials, brand documents. It only takes a few minutes.',
    image: '/assets/images/1.png',
  },
  {
    title: 'Get Verified',
    description: 'We verify your CR, key metrics, and identity to build buyer trust.',
    image: '/assets/images/2.png',
  },
  {
    title: 'Receive Offers',
    description: 'Buyers sign an NDA to view details and send offers through our secure chat.',
    image: '/assets/images/av-1.png',
  },
  {
    title: 'Finalize the Deal',
    description: 'Accept the offer, upload the transfer docs, and get paid directly via bank.',
                ...
                dot: (
                  <img
                    ...
                    style={{
                      ...
                      filter: activeStep === index ? 'drop-shadow(0 0 2px rgba(24, 144, 255, 0.3))' : 'none'
                    }}
                  />
                ),
                children: (
