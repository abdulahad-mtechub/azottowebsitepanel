                    ...
                    <Col span={24}>
                        <Flex vertical justify='center' align='center' gap={15} className='mx-width'>
                            ...
                            <Title className='m-0' level={2}>
                                {t("How Jusoor")}{" "}
                                <span className='text-brand'>{t("Helps You?")}</span>
                            </Title>
                            <Text className='fs-14'>
                               {t("Jusoor is transforming how businesses are bought and sold in Saudi Arabia. We offer a digital marketplace where verified sellers can list their businesses.")}
                            </Text>
                        </Flex>
                    </Col>
                        ...
                        <Col lg={{ span: 8 }} md={{ span: 12 }} sm={{ span: 24 }} xs={{ span: 24 }} key={i}>
                            <Card className='h-100 border-brand rounded-12'>
                                <Flex vertical gap={20} align='center' className='text-center'>
                                    <Image src={type?.icon} preview={false} width={50} alt={t("type icon")} />
                                    <div>
