...
const CounterOffer = ({ visible, onClose, selectedOfferId, title }) => {
    ...
    <Modal
      ...
      footer={
        <Flex justify='end' gap={5}>
          ...
          <Button aria-labelledby={t('Send Counter Offer')} type="primary" className='btn bg-brand' onClick={handleSubmit}>
