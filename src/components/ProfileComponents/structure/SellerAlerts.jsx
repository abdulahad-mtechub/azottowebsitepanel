...
const SellerAlerts = () => {
  ...
  const loadAlerts = useCallback(
    async (offset = 0) => {
      ...
      try {
        ...
        setAlerts((prev) =>
          offset === 0 ? nextAlerts : [...prev, ...nextAlerts]
        );
      } catch (err) {
  ...
  return (
    <Row>
      <Col span={24}>
        <Card
          className="border-gray overflow-style"
              ...
              {fetchError ? (
                <>
                  <img
                    ...
                    alt="error"
                  />
                  <Text type="danger" className="fs-15">
                    {fetchError}
                  </Text>
                </>
              ) : (
            ...
            <>
              ...
              >
                    ...
                    >
                      <Flex justify="space-between" align="flex-start" gap={8}>
                        <Flex vertical gap={6} style={{ flex: 1 }}>
                          ...
                          <Text
                            className="m-0 text-gray fw-400"
                ...
                {fetchError && !isLoadingMore && (
                  <Flex justify="center" className="py-3 mt-2">
                    <Text type="danger" className="fs-13">
                      {fetchError}
                    </Text>
                  </Flex>
                )}
              ...
              <Flex justify="center">
                <Text className="text-gray fs-12">
                  {t("Showing")} {formatNumber(alerts.length)} {t("of")}{" "}
                  {formatNumber(totalCount)} {t("alerts")}
