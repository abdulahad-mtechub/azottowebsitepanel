                    ...
                    <div className='container'>
                        ...
                        <Flex vertical gap={15} className='w-100 search-cs text-center'>
                            ...
                            <Text className='text-light-gray fs-16'>
                                {t('Explore content that helps you make well-informed decisions when buying or selling.')}
                            </Text>
                        </Flex>
                    </div>
                </div>
                            ...
                            <Col span={24} className='mb-3'>
                                <Flex vertical justify='center' align='center' gap={15}>
                                    ...
                                    <Text className='fs-14'>
                                        {t('We share educational and market-driven articles to help you understand the landscape and evaluate opportunities clearly.')}
                                    </Text>
                                </Flex>
                            </Col>
