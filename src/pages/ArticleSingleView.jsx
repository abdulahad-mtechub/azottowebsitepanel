  ...
  return (
    <>
      <div className="padd">
                      ...
                      {isArabic ? (
                        <span
                          dangerouslySetInnerHTML={{
                            __html: data?.getArticle?.arabicBody?.content,
                          }}
                        />
                      ) : (
                        <span
                          dangerouslySetInnerHTML={{
                            __html: data?.getArticle?.body?.content,
                          }}
                        />
                      )}
                    </Paragraph>
        ...
        <SuggestedArticles excludeId={id} />
      </div>
    </>
  );
};
