                            ...
                            items={[
                                ...
                                },
                                {
                                    title: <Text className='fw-500 text-white'>
                                        Jusoor Privacy Policy
                                    </Text>,
                                },
                            ]}
                        />
                        <Flex vertical gap={15} className='w-100 search-cs text-center'>
                            <Title level={2} className='text-white m-0'>Jusoor Privacy Policy</Title>
                        ...
                        <Row gutter={[24, 64]} justify={'center'}>
                            <Col span={24}>
                                <Flex vertical justify='center' align='center' gap={15} className='mx-width'>
                                    <div className='tag bg-secondary fw-500 text-brand'>Jusoor Privacy Policy</div>
                                    <Title className='m-0' level={2}>
                                        Your Privacy, <span className='text-brand'>Our Priority</span>
                                    </Title>
                                    <Text className='fs-14'>
                                        At Jusoor, we value your trust. This Privacy Policy explains how we collect, use, and protect your personal data when you access or use our platform.
                                    </Text>
                                </Flex>
                            </Col>
                                ...
                                <Card className='bg-light-white border-gray'>
                                    <Flex gap={20} className='mb-3'>
                                        ...
                                        <Flex vertical gap={15}>
                                            <Title level={4} className='m-0'> Overview & Acceptance</Title>
                                            <Flex vertical gap={8}>
                                    ...
                                    <Flex gap={20} className='mb-3'>
                                        ...
                                        <Flex vertical gap={15}>
                                            <Title level={4} className='m-0'>Account Creation & Eligibility</Title>
                                            <Flex vertical gap={8}>
                                                <Text className='text-justify'>
