                ...
                <div className='container'>
                    <Breadcrumb
                        ...
                        items={[
                            ...
                            {
                                title: <Text className='fw-500 text-white'>{t('Jusoor E-NDA')}</Text>,
                            },
                        ]}
                    />
                    <Flex vertical gap={15} className='w-100 search-cs text-center'>
                        <Title level={2} className='text-white m-0'>{t('Jusoor E-NDA')}</Title>
                    ...
                    <Row gutter={[24, 64]} justify={'center'}>
                        <Col span={24}>
                            <Flex vertical justify='center' align='center' gap={15} className='mx-width'>
                                <div className='tag bg-secondary fw-500 text-brand'>{t('Jusoor E-NDA')}</div>
                                <Title className='m-0' level={2}>
                                    {t('Understand the Rules of')} <span className='text-brand'>{t('Confidentiality on Jusoor')}</span>
                                </Title>
                                <Text className='fs-14'>
                                    {t('Before any deal on Jusoor, both parties must accept the E-NDA to keep financials, strategies, and client data strictly confidential and secure.')}
                                </Text>
                            </Flex>
                        </Col>
