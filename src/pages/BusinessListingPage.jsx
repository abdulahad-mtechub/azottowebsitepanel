...
import { GET_ALL_BUSINESSES } from "../graphql/query/business";
import { useLazyQuery } from '@apollo/client';
import { useSearchParams } from 'react-router-dom';
import { GET_BUSINESS_BY_CATEGORY, GET_BUSINESS_BY_CITY, GET_BUSINESS_BY_REVENUE, GET_BUSINESS_BY_PROFIT,GET_BUSINESS_BY_DISTRICT } from '../graphql/query/business';
                        ...
                        <Card className='shadow-c rounded'>
                            <Row gutter={[24,24]} align={'middle'}>
                                ...
                                <Col xl={{span: 3}} lg={{span: 4}} md={{span:24}} sm={{span: 24}} xs={{span: 24}}>
                                    <Button className='btn bg-brand fs-14 fw-400 w-100' onClick={handleSearch}>
                                        Search Businesses
                                    </Button>
                                </Col>
                            </Row>
